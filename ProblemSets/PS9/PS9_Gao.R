...
rmse1 <- sqrt(mean((prediction$data$truth-prediction$data$response)^2))
print(rmse1)
...
print(head(prediction$data))
rmse2 <- sqrt(mean((prediction$data$truth-prediction$data$response)^2))
print(rmse2)
...
rmse3 <- sqrt(mean((prediction$data$truth-prediction$data$response)^2))
print(rmse3)
